...
2. The connected device gets the command.
3. Our safe,functional igniter system fires up the firecracker.

It’s simple, safe, and a lot of fun to use. It’s perfect for parties and festivals!

> Always keep a safe distance and make sure there is plenty of open space around the launch area.

**Bonus Feature: Automatic Scheduled Launches**  
Set your firecrackers to launch at a specific time. This is perfect for countdowns and surprise moments.
...
Yes, you read that right. Our basic smart rocket system starts at **less than ₹200**, which includes voice support. It's ideal for anyone wanting smart celebrations on a budget.
